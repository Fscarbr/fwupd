...
* `PCI\VEN_8086&DEV_4905`

They also define custom per-part PCI IDs such as:

* `PCI\VEN_8086&DEV_4905&PART_FWCODE`
* `PCI\VEN_8086&DEV_4905&PART_FWDATA`
* `PCI\VEN_8086&DEV_4905&PART_OPROMCODE`
* `PCI\VEN_8086&DEV_4905&PART_OPROMDATA`

When the device needs recovery, the instance IDs will instead be:

* `PCI\VEN_8086&DEV_4905&PART_FWCODE_RECOVERY`
* `PCI\VEN_8086&DEV_4905&PART_FWDATA_RECOVERY`
* `PCI\VEN_8086&DEV_4905&PART_OPROMCODE_RECOVERY`
* `PCI\VEN_8086&DEV_4905&PART_OPROMDATA_RECOVERY`
